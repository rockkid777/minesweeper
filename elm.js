...
var author$project$Main$genBoard = function (_n0) {
	var x = _n0.a;
	var y = _n0.b;
	return A2(
		elm$core$Array$repeat,
		x,
		A2(elm$core$Array$repeat, y, author$project$Main$Hidden));
};
...
var author$project$Main$init = function (_n0) {
	return _Utils_Tuple2(
		{
			board: author$project$Main$genBoard(
				_Utils_Tuple2(8, 8)),
			bombs: _List_Nil,
			discovered: 0,
			flags: _List_Nil,
			...
			playTime: 0,
			size: _Utils_Tuple2(8, 8),
			status: author$project$Main$Stopped
		},
		elm$core$Platform$Cmd$none);
};
var author$project$Main$Marker = {$: 'Marker'};
var author$project$Main$Running = {$: 'Running'};
var author$project$Main$Blank = {$: 'Blank'};
var author$project$Main$Exploded = {$: 'Exploded'};
...
var author$project$Main$discoverable = F2(
	function (_n0, model) {
		var x = _n0.a;
		var y = _n0.b;
		var field = A2(
			...
			A2(elm$core$Array$get, x, model.board));
		return _Utils_eq(
			field,
			elm$core$Maybe$Just(author$project$Main$Hidden));
	});
...
var author$project$Main$isBomb = F2(
	function (f, l) {
		return A2(elm$core$List$member, f, l);
	});
var author$project$Main$neighbours = function (_n0) {
	var x = _n0.a;
	var y = _n0.b;
	return _List_fromArray(
		[
...
var author$project$Main$nearBombsCount = F2(
	function (_n0, bombs) {
		var x = _n0.a;
		var y = _n0.b;
		return elm$core$List$length(
			A2(
				...
				function (f) {
					return A2(elm$core$List$member, f, bombs);
				},
				author$project$Main$neighbours(
					_Utils_Tuple2(x, y))));
	});
var author$project$Main$nearFieldsOf = F3(
	function (field, _n0, board) {
		var x = _n0.a;
		var y = _n0.b;
		var fn = function (_n1) {
			var x1 = _n1.a;
			...
			return _Utils_eq(
				A2(
					elm$core$Maybe$andThen,
					function (r) {
						return A2(elm$core$Array$get, y1, r);
					},
					A2(elm$core$Array$get, x1, board)),
...
var author$project$Main$nearFlagsCount = F2(
	function (_n0, board) {
		var x = _n0.a;
		var y = _n0.b;
		return elm$core$List$length(
			A3(
				author$project$Main$nearFieldsOf,
...
var author$project$Main$setField = F3(
	function (_n0, f, board) {
		var x = _n0.a;
		var y = _n0.b;
		var _n1 = A2(elm$core$Array$get, x, board);
		if (_n1.$ === 'Just') {
			var row = _n1.a;
			return A3(
				elm$core$Array$set,
				x,
				A3(elm$core$Array$set, y, f, row),
				board);
		} else {
			return board;
		}
...
var author$project$Main$toggleFlagField = F3(
	function (_n0, toggle, model) {
		var x = _n0.a;
		var y = _n0.b;
		var flags = toggle ? elm$core$List$sort(
			A2(
				elm$core$List$cons,
				_Utils_Tuple2(x, y),
				model.flags)) : A2(
		...
		var board = A3(
			...
			_Utils_Tuple2(x, y),
			toggle ? author$project$Main$Flag : author$project$Main$Hidden,
			model.board);
		return _Utils_Tuple2(
			_Utils_update(
				model,
				{board: board, flags: flags}),
			elm$core$Platform$Cmd$none);
	});
var author$project$Main$discover = F2(
	function (_n2, model) {
		var x = _n2.a;
		var y = _n2.b;
		if (!_Utils_eq(model.status, author$project$Main$Running)) {
			return _Utils_Tuple2(model, elm$core$Platform$Cmd$none);
		} else {
			var row = A2(elm$core$Array$get, x, model.board);
			var field = A2(
				elm$core$Maybe$andThen,
				elm$core$Array$get(y),
				row);
			...
			while (true) {
				if (field.$ === 'Just') {
					switch (field.a.$) {
						...
						case 'Hidden':
							var _n5 = field.a;
							if (_Utils_eq(model.mode, author$project$Main$Marker)) {
								return A3(
									author$project$Main$toggleFlagField,
									_Utils_Tuple2(x, y),
									true,
								...
								if (A2(
									author$project$Main$isBomb,
									_Utils_Tuple2(x, y),
									model.bombs)) {
									var board = A3(
										author$project$Main$setField,
										_Utils_Tuple2(x, y),
										author$project$Main$Exploded,
										model.board);
									return _Utils_Tuple2(
										_Utils_update(
											model,
											{board: board, status: author$project$Main$Lost}),
										elm$core$Platform$Cmd$none);
								} else {
									var c = A2(
										author$project$Main$nearBombsCount,
										_Utils_Tuple2(x, y),
										model.bombs);
									if (!c) {
										if (A2(
											author$project$Main$discoverable,
											_Utils_Tuple2(x, y),
											model)) {
											var discovered = model.discovered + 1;
											var b = A3(
												author$project$Main$setField,
												_Utils_Tuple2(x, y),
												...
												model.board);
											return A3(
												author$project$Main$discoverNeighbours,
												_Utils_Tuple2(x, y),
												false,
												_Utils_update(
													model,
													{board: b, discovered: discovered}));
										} else {
											return _Utils_Tuple2(model, elm$core$Platform$Cmd$none);
										}
									} else {
										...
										var board = A3(
											author$project$Main$setField,
											_Utils_Tuple2(x, y),
											author$project$Main$Number(c),
											model.board);
										return _Utils_Tuple2(
											_Utils_update(
												model,
												{board: board, discovered: discovered}),
											elm$core$Platform$Cmd$none);
									}
								}
							}
						case 'Number':
							...
							return _Utils_eq(
								A2(
									author$project$Main$nearFlagsCount,
									_Utils_Tuple2(x, y),
									model.board),
								n) ? A3(
								author$project$Main$discoverNeighbours,
...
var author$project$Main$discoverNeighbours = F3(
	function (_n0, restricted, model) {
		var x = _n0.a;
		var y = _n0.b;
		var nl = restricted ? A3(
			author$project$Main$nearFieldsOf,
			author$project$Main$Hidden,
			_Utils_Tuple2(x, y),
			model.board) : author$project$Main$neighbours(
			_Utils_Tuple2(x, y));
		return A3(
			elm$core$List$foldl,
			F2(
				function (p, _n1) {
					var m = _n1.a;
					return A2(author$project$Main$discover, p, m);
				}),
...
var author$project$Main$genBomb = A2(
	elm$random$Random$generate,
...
var author$project$Main$statFor = F4(
	function (_n0, bombCount, discovered, status) {
		var sx = _n0.a;
		var sy = _n0.b;
		if (status.$ === 'Running') {
			return _Utils_eq(discovered, (sx * sy) - bombCount) ? author$project$Main$Won : status;
		} else {
			return status;
		}
	});
var author$project$Main$update = F2(
	function (msg, model) {
		switch (msg.$) {
			case 'Start':
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{
							board: author$project$Main$genBoard(model.size),
							bombs: _List_Nil,
							discovered: 0,
							flags: _List_Nil,
							playTime: 0,
							status: author$project$Main$Running
						}),
					author$project$Main$genBomb);
			case 'NewGame':
				var b = msg.a;
				if (A2(elm$core$List$member, b, model.bombs)) {
					return _Utils_Tuple2(model, author$project$Main$genBomb);
				} else {
					var bombs = elm$core$List$sort(
						A2(elm$core$List$cons, b, model.bombs));
					var cmd = (elm$core$List$length(bombs) === 10) ? elm$core$Platform$Cmd$none : author$project$Main$genBomb;
					return _Utils_Tuple2(
						_Utils_update(
							model,
							{bombs: bombs, status: author$project$Main$Running}),
						cmd);
				}
			case 'ToggleMode':
				var mode = _Utils_eq(model.mode, author$project$Main$Normal) ? author$project$Main$Marker : author$project$Main$Normal;
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{mode: mode}),
			...
			case 'Click':
				...
				return _Utils_Tuple2(
					_Utils_update(
						...
						{
							status: A4(
								author$project$Main$statFor,
								m.size,
								elm$core$List$length(m.bombs),
								m.discovered,
								m.status)
						}),
					c);
			...
			default:
				var _n5 = model.status;
				if (_n5.$ === 'Running') {
					return _Utils_Tuple2(
						_Utils_update(
							model,
							{playTime: model.playTime + 1}),
						elm$core$Platform$Cmd$none);
				} else {
					return _Utils_Tuple2(model, elm$core$Platform$Cmd$none);
				}
...
var author$project$Main$ToggleFlag = F2(
	function (a, b) {
		return {$: 'ToggleFlag', a: a, b: b};
	});
...
var author$project$Main$onRightClick = function (m) {
	return A2(
						...
						[
							...
							_List_fromArray(
								[
									...
									elm$html$Html$Attributes$class('fa-bomb')
								]),
							_List_Nil)
						]));
			case 'Number':
						...
						[
							...
							_List_fromArray(
								[
									...
									elm$html$Html$Attributes$class('fa-flag')
								]),
							_List_Nil)
						]));
			default:
...
var author$project$Main$toHtmlRow = F2(
	function (x, arr) {
		return A2(
			elm$html$Html$tr,
			_List_Nil,
...
var author$project$Main$view = function (model) {
	...
	var timeDisplay = A2(
		elm$core$List$map,
		digitWrapper,
		A2(author$project$Visuals$displayForWithSize, model.playTime, 3));
	var bombsDisplay = A2(
		elm$core$List$map,
		digitWrapper,
