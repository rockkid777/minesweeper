									...
									if (!c) {
										if (A2(
											...
											var b = A3(
												...
												model.board);
											return A2(
												author$project$Main$populatedBlanks,
												_Utils_Tuple2(x, y),
												_Utils_update(
													model,
...
var author$project$Main$populatedBlanks = F2(
	function (_n0, model) {
		var x = _n0.a;
		var y = _n0.b;
		return A3(
...
_Platform_export({'Main':{'init':author$project$Main$main(elm$json$Json$Decode$int)({"versions":{"elm":"0.19.0"},"types":{"message":"Main.Msg","aliases":{},"unions":{"Main.Msg":{"args":[],"tags":{"Start":[],"NewGame":["( Basics.Int, Basics.Int )"],"ToggleMode":[],"Click":["Basics.Int","Basics.Int"],"ToggleFlag":["Basics.Int","Basics.Int"]}},"Basics.Int":{"args":[],"tags":{"Int":[]}}}}})}});}(this));